...
namespace DND
{
	...
	{
	public:
		static unsigned Get_Pow2_Large(unsigned var);
		static unsigned Get_Unsigned_Length(unsigned var);
		static unsigned Get_Int_Length(int var);
		...
		static void Set_Seed(unsigned int seed);//设置种子
